...
*/
$config['composer_autoload'] = CI_COMPOSER;
...
|
*/
$config['log_date_format'] = CI_DATE_FORMAT;
...
|
*/
$config['cache_path'] = CI_CACHE_PATH;
...
|
*/
$config['encryption_key'] = CI_CRYPT_KEY;
